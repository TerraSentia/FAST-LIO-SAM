...
1. Ubuntu 22.04
2. ROS2 Humble
3. Make sure that all the dependencies mentioned in the [README_ROS1.md](./README_ROS1.md) document or [Dockerfile](./docker_suite_intel_x86_64_amd64/Dockerfile) have been installed on the system. 
